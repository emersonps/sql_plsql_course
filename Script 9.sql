...
INSERT INTO TPESSOA VALUES(5,'F','LETICIA','J',4,'123456');

SELECT * FROM TPESSOA;

--CONTINUAÇAO 22/06/2018
--APAGAR UMA CONSTRAINT
ALTER TABLE TPESSOA DROP CONSTRAINT NOME_DA_CONSTRAINT
CASCADE CONSTRAINT; --CASO DE APAGAR CONSTRAINT RELACIONADAS COM OUTRAS TABELAS.
...
UPDATE TCONTRATO SET DESCONTO = 31 WHERE COD_CONTRATO = 1; --NAO PERMITE ALTERAR O DESCONTO MAIOR QUE 30
UPDATE TCONTRATO SET DESCONTO = 30 WHERE COD_CONTRATO = 1; --PERMITE ALTERAR O DESCONTO ATÉ 30
...
--USANDO ALT+F3 - É SO CLICAR COM O BOTÃO DIRETIO SOBRE A CONSTRAINT (UKs, PKs, FKs, CHKs) E SELECIONAR HABILITAR OU DESABILITAR.

--SELECIONAR AS CONSTRAINTS
SELECT * FROM USER_CONSTRAINTS
WHERE TABLE_NAME = 'TPESSOA';

--CONSTRAINT_TYPE C=CHECK, P=PRIMARY KEY, U=UNIQUE KEY, R=RELACIONAMENTO.
--VERIFICAR A COLUNA CONSTRAINT_NAME, A COLUNA TABLE_NAME E STATUS PARA VERIFICAR A CONSTRAINT QUE ESTA ATIVADA OU DESATIVADA.
--COLUNA SEARCH_CONDITION = MOSTRA A CONDIÇÃO DA CONSTRAINT.
...
SELECT * FROM TPESSOA;
DELETE FROM TPESSOA WHERE COD_PESSOA = 4; --PERMITE ALTERAR O DESCONTO ATÉ 30
COMMIT;